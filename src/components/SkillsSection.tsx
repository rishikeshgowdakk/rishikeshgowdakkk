    ...
    <section id="skills" className="w-full py-20 md:py-32">
      <div className="container mx-auto max-w-6xl text-center px-4 md:px-6">
        ...
        >
          <CarouselContent>
            {skills.map((skill) => (
              <CarouselItem key={skill.name} className="basis-1/2 sm:basis-1/3 md:basis-1/4 lg:basis-1/5">
                <div className="p-1 h-full">
                  <Card className="bg-card/50 border-border hover:border-primary/50 transition-colors duration-300 flex flex-col items-center text-center p-4 h-full justify-center">
                    <CardContent className="p-2 flex flex-col items-center gap-4 group">
                      <div className="relative w-20 h-20 flex items-center justify-center">
                        ...
                        <skill.icon className="relative w-10 h-10 text-primary glow-primary group-hover:scale-110 transition-transform" />
                      </div>
                      <p className="font-semibold text-base text-foreground/90">{skill.name}</p>
                    </CardContent>
                  </Card>
                </div>
              </CarouselItem>
